...
::: {style="background-color:#E4F8D6"}
**TIP**: When you save the notebook, an HTML file containing the code
...
::: {style="background-color:#E4F8D6"}
**TIP**: Lines starting with `#` are used to indicate a comment that is
...
::: {style="background-color:#E4F8D6"}
**TIP**: You'll see we have started naming some of our our 'code
...
::: {style="background-color:#E4F8D6"}
**TIP**: Some languages, like Python, require certain spacing or
...
::: {style="background-color:#E4F8D6"}
***TIP***: 'Comment' or 'uncomment' in RStudio makes it easy to comment
...
::: {style="background-color:#E4F8D6"}
**Tip: Behind the scenes of Plotly**: The plotly R package serializes ggplot2 figures into Plotly's universal
...
Plotly graphs are interactive! You can click on legend entries to toggle traces,
click-and-drag on the chart to zoom, double-click to autoscale, and
