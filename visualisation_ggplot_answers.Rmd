...
will be saved alongside it (click the *Preview* button or press **Ctrl + Shift + K** or OS X: **Cmd + Shift + K** to preview the HTML file).
...
**Ctrl + Shift + K** or OS X: **Cmd + Shift + K** to preview the HTML file in
the 'Viewer' tab). The preview shows you a rendered HTML copy of the
contents of the editor. Consequently, unlike Knit, Preview does not run
...
```{r ggplotly}
# use ggplotly to convert myplot to an interactive visualisation
