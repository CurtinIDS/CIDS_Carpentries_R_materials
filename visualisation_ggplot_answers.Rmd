...
The R Markdown notebook (e.g. *'visualisation_ggplot_answers.Rmd'*) can be viewed or edited in either
...
::: {style="background-color:#E4F8D6"}
**Tip: Behind the scenes of Plotly**: The plotly R package serializes
