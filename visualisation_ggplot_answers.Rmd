...
placing your cursor inside it and pressing **Ctrl + Shift + Enter** or
OS X: **Cmd + Shift + Enter**. To execute a specific line within a code
chunk, placing your cursor on that line and pressing **Ctrl + Enter** or
OS X: **Cmd + Enter**. e.g.
...
or OS X: **Cmd + Option + I**.

When you save the notebook, a HTML file containing the code and output
will be saved alongside it (click the *Preview* button or press **Ctrl +
Shift + K** or OS X: **Cmd + Shift + K** to preview the HTML file).
...
**Ctrl + Shift + K** or OS X: **Cmd + Shift + K** to preview the HTML
...
closing bracket to end the geom_point function call. You can hit `Esc`
...
```{r first_boxplot_add_geom_point}
# add geom_point
...
```{r first_boxplot_add_geom_jitter}
# ad geom_jitter
...
```{r first_boxplot_jitter_plot_type}
...
-   type out `theme()`, put your cursor between the parentheses, and hit
    `Tab` to bring up a list of arguments
