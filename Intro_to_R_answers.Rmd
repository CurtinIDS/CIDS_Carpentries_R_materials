...
the following example (reusing the 2 `..._logical`s from above):
...
some types get preferentially coerced into other types. From the
examples above, can you draw a diagram that represents the hierarchy of
how these data types are coerced?
